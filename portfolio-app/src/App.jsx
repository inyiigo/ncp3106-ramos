...
export default function App() {
  ...
  const educationImages = Array.from({ length: 12 }, (_, i) => asset(`e${i + 1}.png`));
  const hobbiesImages = Array.from({ length: 5 }, (_, i) => asset(`h${i + 1}.png`));
  const awardsImages = Array.from({ length: 3 }, (_, i) => asset(`a${i + 1}.png`));
    ...
    <div style={{ margin: 0, padding: 0 }}>
      ...
      <div
        style={{
          height: "100vh",
          width: "100vw",
          backgroundImage: `url(${asset('firstpage.png')})`,
      ...
      <div
        ...
        style={{
          ...
          height: "100vh",
          width: "100vw",
          backgroundImage: `url(${asset('second_mainbg.png')})`,
          backgroundSize: "cover",
          backgroundPosition: "center",
          display: "flex",
          alignItems: "center",
      ...
      >
        ...
        <div className="social-icons-container">
          <a href="https://www.facebook.com/inyiigo" target="_blank" rel="noopener noreferrer">
            <img src={asset('fb.png')} alt="Facebook" className="social-icon" />
          </a>
          <a href="https://www.tiktok.com/@inyiigoo" target="_blank" rel="noopener noreferrer">
            <img src={asset('tiktok.png')} alt="TikTok" className="social-icon" />
          </a>
          <a href="https://www.instagram.com/inyiigo/" target="_blank" rel="noopener noreferrer">
            <img src={asset('ig.png')} alt="Instagram" className="social-icon" />
          </a>
          <a href="https://www.facebook.com/inyiigo" target="_blank" rel="noopener noreferrer">
            <img src={asset('mail.png')} alt="Email" className="social-icon" />
          </a>
        </div>
        ...
        >
          ...
          >
            <img src={asset('edubg.png')} alt="Education" className="image-button default" />
            <img src={asset('edu_ani.png')} alt="Education animation" className="image-button hover" />
          </div>
          ...
          >
            <img src={asset('hb.png')} alt="Hobbies" className="image-button default" />
            <img src={asset('hobbies_ani.png')} alt="Hobbies animation" className="image-button hover" />
          </div>
          ...
          >
            <img src={asset('awards_cert.png')} alt="Awards" className="image-button default" />
            <img src={asset('award_ani.png')} alt="Awards animation" className="image-button hover" />
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div className={`cards-container ${cardsVisible ? "visible" : ""}`}>
          {/* Card 1 */}
          <div className="card">
            <img src={asset('cards_1.png')} alt="Card 1" className="slide-up-card" />
            <div className="skills-group">
              <div className="skills-row">
                <div className="skill-item">
                  <img src={asset('pyth.png')} alt="Python" className="skill-icon" />
                  <span className="tooltip">Python</span>
                </div>
                <div className="skill-item">
                  <img src={asset('java.png')} alt="Java" className="skill-icon" />
                  <span className="tooltip">Java</span>
                </div>
                <div className="skill-item">
                  <img src={asset('sql.png')} alt="SQL" className="skill-icon" />
          ...
          {/* Card 2 */}
          <div className="card">
            <img src={asset('cards_2.png')} alt="Card 2" className="slide-up-card" />
            <div className="skills-group">
              <div className="skills-row">
                <div className="skill-item">
                  <img src={asset('html.png')} alt="HTML5" className="skill-icon" />
                  <span className="tooltip">HTML5</span>
                </div>
                <div className="skill-item">
                  <img src={asset('css.png')} alt="CSS3" className="skill-icon" />
                  <span className="tooltip">CSS3</span>
                </div>
                <div className="skill-item">
                  <img src={asset('javascript.png')} alt="JavaScript" className="skill-icon" />
                  <span className="tooltip">JavaScript</span>
                </div>
              </div>
              <div className="skills-row">
                <div className="skill-item">
                  <img src={asset('react.png')} alt="React" className="skill-icon" />
                  <span className="tooltip">React</span>
                </div>
                <div className="skill-item">
                  <img src={asset('bootstrap.png')} alt="Bootstrap" className="skill-icon" />
          ...
          <div className="projects-grid">
            ...
            <div className="project-card">
              <div className="project-image">
                <img src={asset('arcade.png')} alt="Arcade App" />
              </div>
            ...
            <div className="project-card">
              <div className="project-image">
                <img src={asset('gg.png')} alt="Guessing Game" />
              </div>
              <div className="project-content">
            ...
            <div className="project-card">
              <div className="project-image">
                <img src={asset('hi_lo.png')} alt="Hi-Lo Game" />
              </div>
              <div className="project-content">
